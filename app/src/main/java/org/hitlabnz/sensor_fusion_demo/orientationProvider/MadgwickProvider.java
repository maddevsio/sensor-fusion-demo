...
//            Log.i("Madgwick", String.format("%f %f %f %f\n", q0, q1, q2, q3));
            currentOrientationQuaternion.setXYZW(q1, q2, q3, -q0); //-q for cube rotation inversion
            MatrixF4x4 m4x4 = currentOrientationQuaternion.getMatrix4x4();
            float[] m4x4f = m4x4.getMatrix();
            android.opengl.Matrix.multiplyMV(testAcc, 0, m4x4f,
                    0, acc, 0);
            Log.i("Madgwick", String.format("%f %f %f %f", testAcc[0], testAcc[1], testAcc[2], testAcc[3]));
            init0 = init1 = init2 = false;
        }
    }
}
